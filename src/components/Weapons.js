...
export default [
    ...
    },
    {
        ...
        levels: [
            { level: 0, damage: 15, extraTargets: "+1" },
            { level: 1, damage: 20, extraTargets: "+2", meleeDamage: "+33.3%" },
            { level: 2, damage: 25, extraTargets: "+3", meleeDamage: "+50%" },
            { level: 3, damage: 30, extraTargets: "+3", meleeDamage: "+66.6%" },
            { level: 4, damage: 35, extraTargets: "+4", meleeDamage: "+100%" },
            { level: 5, damage: 40, extraTargets: "+4", meleeDamage: "+140%" },
        ],
    },
    {
        src: axe,
    ...
    },
    {
        ...
        levels: [
            { level: 0, damage: 75, uses: 4 },
            { level: 1, damage: 84, uses: 5 },
            { level: 2, damage: 93, uses: 6 },
            { level: 3, damage: 102, uses: 7 },
            { level: 4, damage: 111, uses: 8 },
            { level: 5, damage: 120, uses: 9 },
        ],
    },
    {
        src: sledgehammer,
    ...
    },
    {
        ...
        levels: [
            { level: 0, damage: 75, powerAttackDamage: "+30%" },
            {
                level: 1,
                damage: 80,
                powerAttackDamage: "+60%",
